...
@Autonomous(name="Blue-Auto-1", group="LM1")
public class Auto1Blue extends LinearOpMode  {
    //public static double DISTANCE = 64;

    public float targetPower = 0.65f;
    ...
    public void runOpMode() throws InterruptedException {
        MecanumDrive drive = new MecanumDrive(hardwareMap, new Pose2d(-52.0,-47.0,Math.toRadians(45.0)));
        ...
        Actions.runBlocking(drive.actionBuilder(new Pose2d(-53.0, -53.0, Math.toRadians(45.0)))
//                        //.lineToX(DISTANCE)
...
////                        .stopAndAdd(new IntakeAction(intakeMotor, true))
                ...
                .stopAndAdd(new ShooterAction(shooterR, shooterL, targetPower,false))
                .strafeToLinearHeading(new Vector2d(-23.0, -23.0), Math.toRadians(45.0))
              ...
              //  .stopAndAdd(new ShooterAction(shooterR, shooterL, 0.0,true))
                ...
                .strafeToLinearHeading(new Vector2d(11.0, -22.0), Math.toRadians(270.0))
                // move down
                .strafeToLinearHeading(new Vector2d(11.0, -40.0), Math.toRadians(270.0)) // y was originally 49. im testing it as 40
                // move up
                .strafeToLinearHeading(new Vector2d(11.0, -22.0), Math.toRadians(270.0))
                // move to the shoot point
                .strafeToLinearHeading(new Vector2d(23.0, -23.0), Math.toRadians(45.0)) //radians was -43. testing angles. Angle of -43 only messes up on this one
              ...
              //  .stopAndAdd(new ShooterAction(shooterR, shooterL, 0.0,true))
                ...
                .strafeToLinearHeading(new Vector2d(35.0, -18.0), Math.toRadians(270.0))
                // move down
                .strafeToLinearHeading(new Vector2d(34.0, -42.0), Math.toRadians(270.0))
                // move up
                .strafeToLinearHeading(new Vector2d(34.0, -22.0), Math.toRadians(270.0))
                // move to the shoot point
                .strafeToLinearHeading(new Vector2d(23.0, -23.0), Math.toRadians(45.0))
              ...
              //  .stopAndAdd(new ShooterAction(shooterR, shooterL, 0.55,false))
               ...
               // .stopAndAdd(new ShooterAction(shooterR, shooterL, 0.0,true))
                ...
                .strafeToLinearHeading(new Vector2d(35.0, -22.0), Math.toRadians(270.0))
                // move down
                .strafeToLinearHeading(new Vector2d(34.0, -47.0), Math.toRadians(270.0))
                // move up
                .strafeToLinearHeading(new Vector2d(34.0, -22.0), Math.toRadians(270.0))
                // move to the shoot point
                .strafeToLinearHeading(new Vector2d(
                        23.0, -23.0), Math.toRadians(45.0))
                //shoot
              //  .stopAndAdd(new ShooterAction(shooterR, shooterL, 0.55,false))
                //.waitSeconds(2)
                //.stopAndAdd(new IntakeAction(intakeMotor, false))
    ...
    public class ShooterAction implements Action {
        ...
        public boolean run(@NonNull TelemetryPacket telemetryPacket) {
            ...
            if(finished) {
                ...
                shooterMotor1.setVelocity(velocity*2650); //2500 seems to work better than 2800
                shooterMotor2.setVelocity(velocity*2650);
            }
