...
@Autonomous(name="Red-Auto", group="LM1")
public class RedAuto extends LinearOpMode  {
    public static double DISTANCE = 64;

    public float targetPower = 0.45f;
    public float targetVelocity = (float) ((767.6767 * (Math.pow(targetPower,2))) + (2967.6767 * targetPower));
...
//                .stopAndAdd(new PasserAction(passer, passerServo, true))
              ...
              //  .stopAndAdd(new ShooterAction(shooterR, shooterL, 0.0,true))
                ...
                // move to the shoot point
                .stopAndAdd(new ShooterAction(shooterR, shooterL, targetPower,false))
                .strafeToLinearHeading(new Vector2d(-18.0, 18.0), Math.toRadians(-70.0))
                .stopAndAdd(new IntakeAction(intakeMotor, false))
                .stopAndAdd(new PasserAction(passer, passerServo, false))
                .waitSeconds(time/2)
                .stopAndAdd(new PasserAction(passer, passerServo, true))
              ...
              //  .stopAndAdd(new ShooterAction(shooterR, shooterL, 0.0,true))
                ...
                // move to the shoot point
                .stopAndAdd(new ShooterAction(shooterR, shooterL, targetPower,false))
                .strafeToLinearHeading(new Vector2d(-18.0, 18.0), Math.toRadians(-55.0))
                .stopAndAdd(new IntakeAction(intakeMotor, false))
                .stopAndAdd(new PasserAction(passer, passerServo, false))
                .waitSeconds(time)
                .stopAndAdd(new PasserAction(passer, passerServo, true))
